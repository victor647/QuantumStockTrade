...
class Ui_SelectedPerformance(object):
    def setupUi(self, SelectedPerformance):
        ...
        SelectedPerformance.resize(1011, 462)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 989, 60))
        ...
        self.statusbar = QtWidgets.QStatusBar(SelectedPerformance)
        self.statusbar.setObjectName("statusbar")
        SelectedPerformance.setStatusBar(self.statusbar)
        ...
        self.menu.addAction(self.actAutoTest)
    ...
    def retranslateUi(self, SelectedPerformance):
        ...
        self.menu.setTitle(_translate("SelectedPerformance", "批量回测"))
        self.actHoldersStatus.setText(_translate("SelectedPerformance", "十大流通股东"))
        self.actAutoTest.setText(_translate("SelectedPerformance", "回测文件夹下所有选股结果"))
