...
class Ui_SelectedPerformance(object):
    def setupUi(self, SelectedPerformance):
        ...
        self.lblTradeSummary = QtWidgets.QLabel(SelectedPerformance)
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 989, 60))
        ...
        self.btnStartCalculation.setMinimumSize(QtCore.QSize(150, 0))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.lblMoneyPerTrade = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.spbMoneyPerTrade = QtWidgets.QSpinBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.spbLoseThreshold.setMinimum(-99)
        self.spbLoseThreshold.setMaximum(-1)
        ...
        self.lblDownAddPoint = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.lblDownAddPoint.setFont(font)
        self.lblDownAddPoint.setObjectName("lblDownAddPoint")
        self.horizontalLayout.addWidget(self.lblDownAddPoint)
        self.spbDownAddPoint = QtWidgets.QSpinBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.spbDownAddPoint.setFont(font)
        self.spbDownAddPoint.setMinimum(-10)
        self.spbDownAddPoint.setMaximum(0)
        self.spbDownAddPoint.setProperty("value", -3)
        self.spbDownAddPoint.setObjectName("spbDownAddPoint")
        self.horizontalLayout.addWidget(self.spbDownAddPoint)
        self.lblUpAddPoint = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.lblUpAddPoint.setFont(font)
        self.lblUpAddPoint.setObjectName("lblUpAddPoint")
        self.horizontalLayout.addWidget(self.lblUpAddPoint)
        self.spbUpAddPoint = QtWidgets.QSpinBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        self.spbUpAddPoint.setFont(font)
        self.spbUpAddPoint.setMinimum(0)
        self.spbUpAddPoint.setMaximum(10)
        self.spbUpAddPoint.setProperty("value", 3)
        self.spbUpAddPoint.setObjectName("spbUpAddPoint")
        self.horizontalLayout.addWidget(self.spbUpAddPoint)
        self.lblAddDeadline = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.spbAddDeadline = QtWidgets.QSpinBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
    ...
    def retranslateUi(self, SelectedPerformance):
        ...
        item.setText(_translate("SelectedPerformance", "最终获利"))
        self.lblTradeSummary.setText(_translate("SelectedPerformance", "共成交0笔，其中盈利0笔，总成本0元，获利0元，收益率0%"))
        ...
        self.lblDownAddPoint.setText(_translate("SelectedPerformance", "下跌补仓点"))
        self.spbDownAddPoint.setSuffix(_translate("SelectedPerformance", "%"))
        self.lblUpAddPoint.setText(_translate("SelectedPerformance", "上涨加仓点"))
        self.spbUpAddPoint.setSuffix(_translate("SelectedPerformance", "%"))
