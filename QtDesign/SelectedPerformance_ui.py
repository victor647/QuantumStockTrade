...
class Ui_SelectedPerformance(object):
    def setupUi(self, SelectedPerformance):
        ...
        self.cbxAddWhenDown = QtWidgets.QCheckBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.spbAddThresholdDown = QtWidgets.QSpinBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.cbxAddWhenUp = QtWidgets.QCheckBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.spbAddThresholdUp = QtWidgets.QSpinBox(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
    ...
    def retranslateUi(self, SelectedPerformance):
        ...
        item.setText(_translate("SelectedPerformance", "期满表现"))
        ...
        item.setText(_translate("SelectedPerformance", "实际操作"))
        self.lblTradeSummary.setText(_translate("SelectedPerformance", "共买入0只股票，其中0只盈利，总成本0元，获利0元，收益率0%"))
