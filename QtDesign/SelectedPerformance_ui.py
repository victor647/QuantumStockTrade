...
class Ui_SelectedPerformance(object):
    ...
    def retranslateUi(self, SelectedPerformance):
        ...
        self.lblMoneyPerTrade.setText(_translate("SelectedPerformance", "每支股票选股次日开盘买入"))
        ...
        item.setText(_translate("SelectedPerformance", "持股"))
        ...
        item.setText(_translate("SelectedPerformance", "收益率"))
        ...
        item.setText(_translate("SelectedPerformance", "跑赢大盘"))
