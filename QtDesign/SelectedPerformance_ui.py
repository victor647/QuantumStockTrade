...
class Ui_SelectedPerformance(object):
    def setupUi(self, SelectedPerformance):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=SelectedPerformance)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.centralwidget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lblSearchDate = QtWidgets.QLabel(parent=self.centralwidget)
        font = QtGui.QFont()
        ...
        self.dteSearchDate = QtWidgets.QDateEdit(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.btnExportStrategy = QtWidgets.QPushButton(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.btnImporttrategy = QtWidgets.QPushButton(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.btnStartCalculation = QtWidgets.QPushButton(parent=self.centralwidget)
        ...
        self.lblMoneyPerTrade = QtWidgets.QLabel(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.spbMoneyPerTrade = QtWidgets.QSpinBox(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.cbxAddByMa = QtWidgets.QCheckBox(parent=self.centralwidget)
        ...
        self.spbAddMaPeriod = QtWidgets.QSpinBox(parent=self.centralwidget)
        ...
        self.lblAddByMa = QtWidgets.QLabel(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.lblAddByMa.setFont(font)
        self.lblAddByMa.setObjectName("lblAddByMa")
        self.horizontalLayout.addWidget(self.lblAddByMa)
        self.cbxAddByPercent = QtWidgets.QCheckBox(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.spbAddPercent = QtWidgets.QSpinBox(parent=self.centralwidget)
        ...
        self.lblAddByPercent = QtWidgets.QLabel(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.spbAddPriceLimit = QtWidgets.QSpinBox(parent=self.centralwidget)
        ...
        self.cbxClearByEarning = QtWidgets.QCheckBox(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.spbClearEarning = QtWidgets.QSpinBox(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.cbxClearByLosing = QtWidgets.QCheckBox(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.spbClearLosing = QtWidgets.QSpinBox(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.cbxClearByMa = QtWidgets.QCheckBox(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.spbClearMaPeriod = QtWidgets.QSpinBox(parent=self.centralwidget)
        ...
        self.lblClearByMa = QtWidgets.QLabel(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.menubar = QtWidgets.QMenuBar(parent=SelectedPerformance)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1295, 22))
        self.menubar.setObjectName("menubar")
        SelectedPerformance.setMenuBar(self.menubar)
        self.actHoldersStatus = QtGui.QAction(parent=SelectedPerformance)
        self.actHoldersStatus.setObjectName("actHoldersStatus")
        self.actAutoTest = QtGui.QAction(parent=SelectedPerformance)
        self.actAutoTest.setObjectName("actAutoTest")

        self.retranslateUi(SelectedPerformance)
        self.btnStartCalculation.clicked.connect(SelectedPerformance.start_trade_simulation) # type: ignore
        self.btnImportStockList.clicked.connect(SelectedPerformance.import_stock_list) # type: ignore
        self.btnRemoveStock.clicked.connect(SelectedPerformance.remove_stock_code) # type: ignore
        self.btnAddStock.clicked.connect(SelectedPerformance.add_stock_code) # type: ignore
        self.btnClearStocks.clicked.connect(SelectedPerformance.clear_stock_list) # type: ignore
        self.btnExportStockList.clicked.connect(SelectedPerformance.export_stock_list) # type: ignore
        self.dteSearchDate.editingFinished.connect(SelectedPerformance.update_start_date) # type: ignore
        self.tblStockList.cellDoubleClicked['int','int'].connect(SelectedPerformance.show_stock_graph) # type: ignore
        self.cbxClearByLosing.toggled['bool'].connect(self.spbClearLosing.setEnabled) # type: ignore
        self.cbxClearByEarning.toggled['bool'].connect(self.spbClearEarning.setEnabled) # type: ignore
        self.btnExportStrategy.clicked.connect(SelectedPerformance.export_trade_strategy) # type: ignore
        self.btnImporttrategy.clicked.connect(SelectedPerformance.import_trade_strategy) # type: ignore
