...
class Ui_SearchResult(object):
    def setupUi(self, SearchResult):
        ...
        SearchResult.resize(722, 311)
        self.verticalLayout = QtWidgets.QVBoxLayout(SearchResult)
        self.verticalLayout.setObjectName("verticalLayout")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lblTotalStockFound = QtWidgets.QLabel(parent=SearchResult)
        font = QtGui.QFont()
        ...
        self.lblSearchDate = QtWidgets.QLabel(parent=SearchResult)
        ...
        self.btnDeleteStock = QtWidgets.QPushButton(parent=SearchResult)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.btnExportStockList = QtWidgets.QPushButton(parent=SearchResult)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.tblStockList = QtWidgets.QTableWidget(parent=SearchResult)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
    ...
    def retranslateUi(self, SearchResult):
        ...
        item.setText(_translate("SearchResult", "行业板块"))
        item = self.tblStockList.horizontalHeaderItem(3)
        item.setText(_translate("SearchResult", "当日收盘"))
        item = self.tblStockList.horizontalHeaderItem(4)
        item.setText(_translate("SearchResult", "次日最高"))
        ...
        item.setText(_translate("SearchResult", "五日最低"))
