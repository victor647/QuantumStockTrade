...
class Ui_SearchResult(object):
    def setupUi(self, SearchResult):
        ...
        self.lblSearchProgress = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.lblSearchProgress.setFont(font)
        self.lblSearchProgress.setObjectName("lblSearchProgress")
        self.verticalLayout.addWidget(self.lblSearchProgress)
        self.lblCurrentAnalyzing = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.lblCurrentAnalyzing.setFont(font)
