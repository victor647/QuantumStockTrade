...
class Ui_SearchResult(object):
    def setupUi(self, SearchResult):
        ...
        SearchResult.resize(508, 360)
        self.tblStockList = QtWidgets.QTableWidget(SearchResult)
        self.tblStockList.setGeometry(QtCore.QRect(10, 40, 491, 311))
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(12, 10, 491, 25))
        self.layoutWidget.setObjectName("layoutWidget")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lblTotalStockFound = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
