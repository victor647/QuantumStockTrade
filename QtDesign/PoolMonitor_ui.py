...
class Ui_PoolMonitor(object):
    def setupUi(self, PoolMonitor):
        ...
        self.lblNewStockCode = QtWidgets.QLabel(PoolMonitor)
        font = QtGui.QFont()
        ...
        self.iptStockCode = QtWidgets.QLineEdit(PoolMonitor)
        ...
        self.btnAddStock = QtWidgets.QPushButton(PoolMonitor)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.btnRemoveStock = QtWidgets.QPushButton(PoolMonitor)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.btnClearStocks = QtWidgets.QPushButton(PoolMonitor)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        font.setPointSize(9)
        ...
        self.btnImportPool = QtWidgets.QPushButton(PoolMonitor)
