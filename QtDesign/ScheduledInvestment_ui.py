...
class Ui_ScheduledInvestment(object):
    def setupUi(self, ScheduledInvestment):
        ...
        ScheduledInvestment.resize(708, 391)
        ...
        self.spbInterval = QtWidgets.QSpinBox(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        self.spbInterval.setFont(font)
        self.spbInterval.setPrefix("")
        self.spbInterval.setMinimum(1)
        self.spbInterval.setMaximum(50)
        self.spbInterval.setObjectName("spbInterval")
        self.horizontalLayout_2.addWidget(self.spbInterval)
        self.cbbIntervalType = QtWidgets.QComboBox(self.centralwidget)
        self.cbbIntervalType.setMaximumSize(QtCore.QSize(60, 16777215))
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        ...
        self.cbbInvestTime = QtWidgets.QComboBox(self.centralwidget)
        self.cbbInvestTime.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        self.cbbInvestTime.setFont(font)
        self.cbbInvestTime.setObjectName("cbbInvestTime")
        self.horizontalLayout_2.addWidget(self.cbbInvestTime)
        ...
        self.cbxSmartInvesting = QtWidgets.QCheckBox(self.centralwidget)
        self.cbxSmartInvesting.setChecked(True)
        self.cbxSmartInvesting.setObjectName("cbxSmartInvesting")
        self.horizontalLayout_3.addWidget(self.cbxSmartInvesting)
        self.spbSmartInvestFactor = QtWidgets.QSpinBox(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        self.spbSmartInvestFactor.setFont(font)
        self.spbSmartInvestFactor.setPrefix("")
        self.spbSmartInvestFactor.setMinimum(1)
        self.spbSmartInvestFactor.setMaximum(20)
        self.spbSmartInvestFactor.setProperty("value", 5)
        self.spbSmartInvestFactor.setObjectName("spbSmartInvestFactor")
        self.horizontalLayout_3.addWidget(self.spbSmartInvestFactor)
        ...
        self.horizontalLayout_3.addWidget(self.btnAutoSplitRatio)
        ...
        self.cbxSmartInvesting.toggled['bool'].connect(self.spbSmartInvestFactor.setEnabled)
    ...
    def retranslateUi(self, ScheduledInvestment):
        ...
        self.cbxSmartInvesting.setText(_translate("ScheduledInvestment", "智能定投：每涨跌1%减少增加投资额"))
        self.spbSmartInvestFactor.setSuffix(_translate("ScheduledInvestment", "%"))
        ...
        item.setText(_translate("ScheduledInvestment", "盈亏金额"))
