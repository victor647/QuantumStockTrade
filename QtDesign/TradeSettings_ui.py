...
class Ui_TradeSettings(object):
    def setupUi(self, TradeSettings):
        ...
        self.label = QtWidgets.QLabel(parent=TradeSettings)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        self.spbBrokerFeePercentage = QtWidgets.QDoubleSpinBox(parent=TradeSettings)
        ...
        self.label_3 = QtWidgets.QLabel(parent=TradeSettings)
        ...
        self.spbMinBrokerFee = QtWidgets.QSpinBox(parent=TradeSettings)
        font = QtGui.QFont()
        font.setFamily("Helvetica")
        ...
        self.label_2 = QtWidgets.QLabel(parent=TradeSettings)
        ...
        self.spbStampDuty = QtWidgets.QDoubleSpinBox(parent=TradeSettings)
        ...
        self.btnSave = QtWidgets.QPushButton(parent=TradeSettings)
        self.btnSave.setObjectName("btnSave")
        self.horizontalLayout_2.addWidget(self.btnSave)
        self.verticalLayout.addLayout(self.horizontalLayout_2)

        self.retranslateUi(TradeSettings)
        self.btnSave.clicked.connect(TradeSettings.save_settings) # type: ignore
