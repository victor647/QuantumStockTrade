...
class Ui_LiveTracker(object):
    def setupUi(self, LiveTracker):
        ...
        self.grpEventSignal.setGeometry(QtCore.QRect(10, 320, 401, 151))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 381, 120))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 401, 60))
        ...
        self.widget1.setGeometry(QtCore.QRect(10, 280, 401, 27))
    ...
    def retranslateUi(self, LiveTracker):
        ...
        item.setText(_translate("LiveTracker", "5分钟涨跌"))
        item = self.tblStockList.horizontalHeaderItem(4)
        item.setText(_translate("LiveTracker", "1分钟外盘"))
