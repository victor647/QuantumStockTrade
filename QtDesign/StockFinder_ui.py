...
class Ui_StockFinder(object):
    def setupUi(self, StockFinder):
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 23, 321, 306))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.grpTechnicalCriterias.setGeometry(QtCore.QRect(360, 180, 271, 321))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(11, 24, 252, 281))
        ...
        self.cbbMacdPosition = QtWidgets.QComboBox(self.layoutWidget3)
        self.cbbMacdPosition.setObjectName("cbbMacdPosition")
        self.horizontalLayout_11.addWidget(self.cbbMacdPosition)
        ...
        self.spbKdjThreshold.setProperty("value", 50)
        ...
        self.cbxRsiEnabled = QtWidgets.QCheckBox(self.layoutWidget3)
        self.cbxRsiEnabled.setChecked(True)
        self.cbxRsiEnabled.setObjectName("cbxRsiEnabled")
        self.horizontalLayout_19.addWidget(self.cbxRsiEnabled)
        self.spbRsiTimePeriod = QtWidgets.QSpinBox(self.layoutWidget3)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.spbRsiTimePeriod.setFont(font)
        self.spbRsiTimePeriod.setMinimum(5)
        self.spbRsiTimePeriod.setMaximum(50)
        self.spbRsiTimePeriod.setProperty("value", 6)
        self.spbRsiTimePeriod.setObjectName("spbRsiTimePeriod")
        self.horizontalLayout_19.addWidget(self.spbRsiTimePeriod)
        self.cbbRsiBehaviour = QtWidgets.QComboBox(self.layoutWidget3)
        self.cbbRsiBehaviour.setObjectName("cbbRsiBehaviour")
        self.horizontalLayout_19.addWidget(self.cbbRsiBehaviour)
        self.spbRsiThreshold = QtWidgets.QSpinBox(self.layoutWidget3)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.spbRsiThreshold.setFont(font)
        self.spbRsiThreshold.setSuffix("")
        self.spbRsiThreshold.setMinimum(0)
        self.spbRsiThreshold.setMaximum(100)
        self.spbRsiThreshold.setProperty("value", 50)
        self.spbRsiThreshold.setObjectName("spbRsiThreshold")
        self.horizontalLayout_19.addWidget(self.spbRsiThreshold)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 530, 621, 31))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.horizontalLayout_20 = QtWidgets.QHBoxLayout(self.layoutWidget4)
        ...
        self.horizontalLayout_20.addWidget(self.btnGetAllStockList)
        ...
        self.horizontalLayout_20.addWidget(self.btnGetAllStockData)
        self.lblGetStockReminder = QtWidgets.QLabel(self.centralwidget)
        self.lblGetStockReminder.setGeometry(QtCore.QRect(370, 500, 243, 25))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.cbxMacdEnabled.clicked['bool'].connect(self.cbbMacdPosition.setEnabled)
        ...
        self.cbxRsiEnabled.clicked['bool'].connect(self.cbbRsiBehaviour.setEnabled)
        self.cbxRsiEnabled.clicked['bool'].connect(self.spbRsiThreshold.setEnabled)
        self.cbxRsiEnabled.clicked['bool'].connect(self.spbRsiTimePeriod.setEnabled)
    ...
    def retranslateUi(self, StockFinder):
        ...
        self.lblTechnicalTimePeriod.setText(_translate("StockFinder", "指标发生指定变化"))
        ...
        self.cbxRsiEnabled.setText(_translate("StockFinder", "RSI"))
        self.spbRsiTimePeriod.setSuffix(_translate("StockFinder", "日线"))
        ...
        self.btnGetAllStockList.setText(_translate("StockFinder", "获取两市全部股票列表"))
        self.btnStartSearch.setText(_translate("StockFinder", "开始搜索选股！"))
        self.btnGetAllStockData.setText(_translate("StockFinder", "获取全部股票最近一年日K线"))
