...
class Ui_StockFinder(object):
    def setupUi(self, StockFinder):
        ...
        self.widget.setGeometry(QtCore.QRect(360, 458, 271, 62))
        ...
        self.btnGetAllStockList = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.btnGetAllStockData = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.btnHistoryPerformance = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.btnHistoryPerformance.setFont(font)
        self.btnHistoryPerformance.setObjectName("btnHistoryPerformance")
        self.horizontalLayout_20.addWidget(self.btnHistoryPerformance)
        ...
        self.btnHistoryPerformance.clicked.connect(StockFinder.test_selected_performance)
    ...
    def retranslateUi(self, StockFinder):
        ...
        self.btnHistoryPerformance.setText(_translate("StockFinder", "回测选股表现"))
