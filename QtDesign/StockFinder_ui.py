...
class Ui_StockFinder(object):
    def setupUi(self, StockFinder):
        ...
        self.spbAverageVolumePeriod = QtWidgets.QSpinBox(self.layoutWidget1)
        self.spbAverageVolumePeriod.setEnabled(True)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.spbAverageVolumePeriod.setFont(font)
        self.spbAverageVolumePeriod.setMaximum(20)
        self.spbAverageVolumePeriod.setProperty("value", 10)
        self.spbAverageVolumePeriod.setObjectName("spbAverageVolumePeriod")
        self.horizontalLayout_3.addWidget(self.spbAverageVolumePeriod)
        ...
        self.spbAveragePricePeriod = QtWidgets.QSpinBox(self.layoutWidget1)
        self.spbAveragePricePeriod.setEnabled(True)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        self.spbAveragePricePeriod.setFont(font)
        self.spbAveragePricePeriod.setMaximum(20)
        self.spbAveragePricePeriod.setProperty("value", 10)
        self.spbAveragePricePeriod.setObjectName("spbAveragePricePeriod")
        self.horizontalLayout_4.addWidget(self.spbAveragePricePeriod)
    ...
    def retranslateUi(self, StockFinder):
        ...
        self.spbAverageVolumePeriod.setSuffix(_translate("StockFinder", "日平均"))
        self.spbVolumeMultipler.setSuffix(_translate("StockFinder", "倍"))
        self.cbxAveragePriceBias.setText(_translate("StockFinder", "昨日股价"))
        self.spbAveragePricePeriod.setSuffix(_translate("StockFinder", "日均线"))
