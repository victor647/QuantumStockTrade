...
class Ui_SearchCriteria(object):
    def setupUi(self, SearchCriteria):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 301, 23))
        font = QtGui.QFont()
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(322, 10, 211, 52))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.rbnPastAverage.clicked['bool'].connect(self.spbAbsValue.setEnabled)
        self.rbnAbsValue.clicked['bool'].connect(self.spbAveragePeriod.setEnabled)
        self.rbnAbsValue.clicked['bool'].connect(self.spbRelativePercentage.setEnabled)
