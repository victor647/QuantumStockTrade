...
class Ui_SearchCriteria(object):
    def setupUi(self, SearchCriteria):
        ...
        SearchCriteria.resize(645, 75)
        self.layoutWidget = QtWidgets.QWidget(SearchCriteria)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 316, 25))
        font = QtGui.QFont()
        ...
        self.lblFirst.setMaximumSize(QtCore.QSize(35, 16777215))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.spbFirstPeriod.setMaximum(250)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(340, 10, 291, 58))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.spbAveragePeriod.setMaximum(250)
        ...
        self.cbbComparedLogic = QtWidgets.QComboBox(self.layoutWidget1)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        ...
        self.spbRelativePercentage.setMinimum(0.0)
        self.spbRelativePercentage.setMaximum(1000.0)
        self.spbRelativePercentage.setProperty("value", 100.0)
        ...
        self.spbAbsValue.setMinimum(-10000.0)
        self.spbAbsValue.setMaximum(10000.0)
    ...
    def retranslateUi(self, SearchCriteria):
        ...
        self.spbAveragePeriod.setSuffix(_translate("SearchCriteria", "日"))
